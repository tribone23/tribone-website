          ...
          <li>
            ...
            >
              <span className='nav-link-icon'>
                <i className={pathname === "/dashboard" ? "bi bi-bar-chart" : "bi bi-bar-chart text-light"} />
              </span>
              <span className='text-light'>Dashboard</span>
            </Link>
            <Link
              className={pathname === "/dashboard/jadwal" ? "m-2 active" : "m-2"}
              to='/dashboard/jadwal'
            >
              <span className='nav-link-icon'>
                <i className={pathname === "/dashboard/jadwal" ? "bi bi-receipt" : "bi bi-receipt text-light"} />
              </span>
              <span className='text-light'>Jadwal Matkul</span>
            </Link>
            <Link
              className={pathname === "/dashboard/piketkelas" ? "m-2 active" : "m-2"}
              to={"/dashboard/piketkelas"}
            >
              <span className='nav-link-icon'>
                <i className={pathname === "/dashboard/piketkelas" ? "bi bi-check-circle" : "bi bi-check-circle text-light"} />
              </span>
              <span className='text-light'>Jadwal Piket</span>
            </Link>
            <Link
              className={pathname === "/dashboard/kaskelas" ? "m-2 active" : "m-2"}
              to={"/dashboard/kaskelas"}
            >
              <span className='nav-link-icon'>
                <i className={pathname === "/dashboard/kaskelas" ? "bi bi-wallet2" : "bi bi-wallet2 text-light"} />
              </span>
              <span className='text-light'>Kas Kelas</span>
            </Link>
            <Link
              className={pathname === "/dashboard/settings" ? "m-2 active" : "m-2"}
              to={"/dashboard/settings"}
            >
              <span className='nav-link-icon'>
                <i className={pathname === "/dashboard/settings" ? "bi bi-person-badge" : "bi bi-person-badge text-light"} />
              </span>
