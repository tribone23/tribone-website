!(function (t, s, e, i) {
  ...
  var a = function () {},
    ...
    n = function (s, e) {
      ...
      (this.element = s),
        (this.$el = t(s)),
        (this.settings = t.extend({}, r, e)),
        (i = this.$el.data("rating") || this.settings.initialRating),
        (a = (
          (this.settings.forceRoundUp ? Math.ceil : Math.round)(2 * i) / 2
        ).toFixed(1)),
        (this._state = { rating: a }),
    ...
    o = {
      ...
      restoreState: function (t) {
        ...
        this.paintStars(e - 1, i),
          this.settings.onLeave(s + 1, this._state.rating, this.$el);
      },
      getIndex: function (s) {
        ...
        (a = a || this.getOffsetByPixel(s, e, i)),
          (a = this.settings.useFullStars ? "right" : a);
        var n = e.index() - ("left" === a ? 0.5 : 0);
        return (
          (n = n < 0.5 && s.offsetX < i / 4 ? -1 : n),
          (n = r && r <= this.settings.totalStars && n < r ? r - 1 : n)
        );
      },
      getOffsetByPixel: function (t, s, e) {
        return t.pageX - s.offset().left <= e / 2 && !this.settings.useFullStars
          ? "left"
          : "right";
      },
      initRating: function () {
      ...
      paintStars: function (s, e) {
        ...
        t.each(
          this.$stars,
          function (l, h) {
            (i = t(h).find('[data-side="left"]')),
              (a = t(h).find('[data-side="right"]')),
              (r = n = l <= s ? e : "empty"),
              (r = l - s == 0.5 ? e : r),
              i.attr("class", "svg-" + r + "-" + this._uid),
              a.attr("class", "svg-" + n + "-" + this._uid);
            var d;
            s >= 0 && Math.ceil(s);
            (d =
              o.ratedColor && o.ratedColor.length
                ? o.ratedColor
                : this._defaults.ratedColor),
              "rated" === e &&
                s > -1 &&
                ((l <= Math.ceil(s) || (l < 1 && s < 0)) &&
                  i.attr("style", "fill:" + d),
                l <= s && a.attr("style", "fill:" + d));
          }.bind(this),
        );
      },
      renderMarkup: function () {
        for (
          var t = this.settings,
            s = t.baseUrl ? location.href.split("#")[0] : "",
            e =
              ...
              this.getSvgDimensions(t.starShape) +
              " stroke-width:" +
              t.strokeWidth +
      ...
      getVectorPath: function (t, s) {
        return "rounded" === s.starShape
          ? this.getRoundedVectorPath(t, s)
          : this.getSpikeVectorPath(t, s);
      },
    ...
    l = {
      ...
      setRating: function (s, e) {
        ...
        s > i.settings.totalStars ||
          s < 0 ||
          (e && (s = Math.round(s)), i.applyRating(s));
      },
      getRating: function () {
      ...
      resize: function (s) {
        ...
        s <= 1 || s > 200
          ...
          : (e = Array.prototype.slice.call(e)).forEach(function (e) {
              t(e).css({ width: s + "px", height: s + "px" });
            });
      },
      setReadOnly: function (s) {
        var e = t(this).data("plugin_starRating");
        !0 === s
          ? e.$stars.off("mouseover mouseout click")
          : ((e.settings.readOnly = !1), e.addListeners());
      },
    };
  t.extend(n.prototype, o),
    (t.fn.starRating = function (s) {
      if (!t.isPlainObject(s)) {
        if (l.hasOwnProperty(s))
          return l[s].apply(this, Array.prototype.slice.call(arguments, 1));
        t.error("Method " + s + " does not exist on starRating.js");
      }
      return this.each(function () {
        t.data(this, "plugin_starRating") ||
          t.data(this, "plugin_starRating", new n(this, s));
      });
    });
