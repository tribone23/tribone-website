...
!(function () {
  ...
  function s(s, r) {
    ...
    if (
    ...
    ) {
      {
        var S = [
          ...
          '<button type="button" class="btn btn-sm btn-light clockpicker-button clockpicker-am-button">',
          "AM</button>",
          '<button type="button" class="btn btn-sm btn-light clockpicker-button clockpicker-pm-button">',
          "PM</button>",
          "</div>",
        ].join("");
        n(S);
      ...
      n(
        '<button type="button" class="btn btn-sm btn-light clockpicker-button am-button">AM</button>',
      )
        .on("click", function () {
        ...
        n(
          '<button type="button" class="btn btn-sm btn-light clockpicker-button pm-button">PM</button>',
        )
          .on("click", function () {
            (x.amOrPm = "PM"),
    ...
    r.autoclose ||
      n(
        '<div class="d-grid p-3 pt-0"><button type="button" class="btn btn-primary clockpicker-button">' +
          r.donetext +
          "</button></div>",
      )
