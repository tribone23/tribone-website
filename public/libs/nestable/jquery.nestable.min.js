...
!(function (t, e, s, i) {
  ...
  (a.prototype = {
    init: function () {
      ...
      o &&
        (s.el[0].addEventListener("touchstart", n, !1),
    ...
    removeAll: function (e) {
      var s = this,
        i = this.options,
        o = s.el.find(i.listNodeName).first(),
        n = o.children(i.itemNodeName),
        l = i.effect.animation || "fade",
        a = i.effect.time || "slow";
      function r() {
        n.each(function () {
          s.removeItem(t(this));
        }),
    ...
    _buildItem: function (e, s) {
      ...
      var o = s.contentCallback(e),
        n = this._buildList(e.children, s),
        l = t(s.itemRenderer(i, o, n, s, e));
      return this.setParent(l), l[0].outerHTML;
    },
    serialize: function () {
      var e = this,
        s = function (i) {
    ...
    asNestedSet: function () {
      ...
      return (
        this.el
          .find(e.listNodeName)
          .first()
          .children(e.itemNodeName)
          .each(function () {
            i = (function i(n, l, a) {
              var r,
                d,
                h = a + 1;
              t(n).children(e.listNodeName).children(e.itemNodeName).length >
                0 &&
                (l++,
                t(n)
                  .children(e.listNodeName)
                  .children(e.itemNodeName)
                  .each(function () {
                    h = i(t(this), l, h);
                  }),
              ...
              d =
                t(n)
                  .parent(e.listNodeName)
                  .parent(e.itemNodeName)
                  .attr("data-id") || "";
              o(d) && (r = parseInt(d));
              r && s.push({ id: r, parent_id: d, depth: l, lft: a, rgt: h });
              a = h + 1;
              return a;
            })(this, 0, i);
          }),
    ...
    toHierarchy: function (e) {
      ...
      return (
        t(this.element)
          ...
          .each(function () {
            var e = (function e(i) {
              var o = (t(i).attr(s.attribute || "id") || "").match(
                s.expression || /(.+)[-=_](.+)/,
              );
              if (o) {
                var n = { id: o[2] };
                return (
                  t(i).children(s.listType).children(s.items).length > 0 &&
                    ((n.children = []),
                    t(i)
                      .children(s.listType)
                      .children(s.items)
    ...
    toArray: function () {
      var e = t.extend({}, this.options, this),
        s = e.startDepthCount || 0,
        i = [],
        o = 2;
      return (
        this.el
          .find(this.options.listNodeName)
          .first()
          .children(this.options.itemNodeName)
          .each(function () {
            o = (function o(n, l, a) {
              var r,
                d,
                h = a + 1;
              n
                .children(e.options.listNodeName)
                .children(e.options.itemNodeName).length > 0 &&
                (l++,
                n
                  .children(e.options.listNodeName)
                  .children(e.options.itemNodeName)
                  .each(function () {
                    h = o(t(this), l, h);
                  }),
                l--);
              ...
              if (l === s + 1) d = e.rootID;
                ...
                var c = n
                  .parent(e.options.listNodeName)
                  .parent(e.options.itemNodeName)
                  .data();
                d = c.id;
              }
              r && i.push({ id: r, parent_id: d, depth: l, left: a, right: h });
              a = h + 1;
              return a;
            })(t(this), s + 1, o);
          }),
    ...
    restoreItemAtIndex: function (e, s) {
      ...
      for (var l = 0; l < s.length; l++) {
        if (o === parseInt(l)) return void n(i, e);
        var a = i[0] ? i[0] : i,
          r = a.children[s[l]];
        i = r || this.createSubLevel(t(a));
      }
    },
    dragStop: function (t) {
    ...
    dragMove: function (i) {
      ...
      var f = !1;
      if (
        (n || (this.dragEl[0].style.visibility = "hidden"),
        (this.pointEl = t(
          s.elementFromPoint(
        ...
        this.each(function () {
          ...
          if (e) {
            if ("string" == typeof s && "function" == typeof e[s])
              if (o.length > 1) {
                for (var n = [], l = 1; l < o.length; l++) n.push(o[l]);
                i = e[s].apply(e, n);
              } else i = e[s]();
          } else
            Nestable.counter++,
              t(this).data("nestable", new a(this, s)),
