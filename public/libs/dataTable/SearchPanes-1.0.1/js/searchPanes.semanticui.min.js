(function (b) {
  "function" === typeof define && define.amd
    ...
    : "object" === typeof exports
      ? (module.exports = function (a, c) {
          ...
          c.fn.dataTable.searchPanes ||
            require("datatables.net-searchpanes")(a, c);
          return b(c, a, a.document);
        })
      : b(jQuery, window, document);
})(function (b, a, c) {
  a = b.fn.dataTable;
  b.extend(!0, a.SearchPane.classes, {
  ...
  b.extend(!0, a.SearchPanes.classes, {
    clearAll: "dtsp-clearAll ui button",
    container: "dtsp-searchPanes ui grid",
  });
  a.SearchPane.prototype._searchContSetup = function () {
    b('<i class="' + this.classes.paneInputButton + '"></i>').appendTo(
      this.dom.searchCont,
    );
  };
