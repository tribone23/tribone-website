...
(function () {
  ...
  var SearchPane = /** @class */ (function () {
        ...
        if (rowData.arrayFilter.length === 0) {
          ...
          if (
            ...
            if (idx !== -1) {
              ...
              rowData.arrayOriginal =
                loadedFilter.searchPanes.panes[idx].arrayFilter;
            } else {
              this.dom.container.addClass(this.classes.hidden);
              this.s.displayed = false;
              return;
      ...
      if (this.colExists) {
        ...
        for (var i = 0, ien = rowData.arrayFilter.length; i < ien; i++) {
          if (
            ...
            if (
              colOpts.preSelect !== undefined &&
              colOpts.preSelect.indexOf(rowData.arrayFilter[i].filter) !== -1
            ) {
              row.select();
            }
          } else {
    ...
    SearchPane.prototype._detailsPane = function () {
      ...
      table.rows().every(function (rowIdx) {
        _this._populatePaneArray(
          rowIdx,
          _this.s.rowData.arrayTotals,
          settings,
          _this.s.rowData.binsTotal,
        );
      });
    };
    /**
    ...
    SearchPane.prototype._findUnique = function (data, arrayFilter) {
      var prev = [];
      for (
        var _i = 0, arrayFilter_1 = arrayFilter;
        _i < arrayFilter_1.length;
        _i++
      ) {
  ...
  var SearchPanes = /** @class */ (function () {
        ...
        if (!this.regenerating) {
          ...
          if (this.s.selectionList.length > 0) {
            ...
            for (var _d = 0, _e = this.s.panes; _d < _e.length; _d++) {
              var pane = _e[_d];
              pane.s.lastSelect =
                pane.s.index === last && this.s.selectionList.length === 1;
            }
          }
          ...
          if (
            ...
            newSelectionList.length < this.s.selectionList.length
          ) {
    ...
    SearchPanes.prototype._makeCascadeSelections = function (newSelectionList) {
      ...
      for (
        var _i = 0, newSelectionList_1 = newSelectionList;
        _i < newSelectionList_1.length;
        _i++
      ) {
    ...
    SearchPanes.prototype._startup = function (table) {
      ...
      table
        ...
        .each(function (idx) {
          if (
            _this.s.panes[idx] !== undefined &&
            _this.s.panes[idx].s.dtPane !== undefined &&
            _this.s.panes[idx].s.colOpts.preSelect !== undefined
          ) {
            var tableLength = _this.s.panes[idx].s.dtPane
              .rows()
              .data()
              .toArray().length;
            for (var i = 0; i < tableLength; i++) {
              if (
                _this.s.panes[idx].s.colOpts.preSelect.indexOf(
                  _this.s.panes[idx].s.dtPane.cell(i, 0).data(),
                ) !== -1
              ) {
