...
$(document).ready(function () {
  ...
  function apex_chart_demo_1() {
    ...
    new ApexCharts(
      document.querySelector("#apex_chart_demo_1"),
      options,
    ).render();
  }
  ...
  function apex_chart_demo_2() {
    ...
    new ApexCharts(
      document.querySelector("#apex_chart_demo_2"),
      options,
    ).render();
  }
  ...
  function apex_chart_demo_3() {
    ...
    new ApexCharts(
      document.querySelector("#apex_chart_demo_3"),
      options,
    ).render();
  }
  ...
  function apex_chart_demo_4() {
    ...
    new ApexCharts(
      document.querySelector("#apex_chart_demo_4"),
      options,
    ).render();
  }
  ...
  function apex_chart_demo_5() {
    ...
    new ApexCharts(
      document.querySelector("#apex_chart_demo_5"),
      options,
    ).render();
  }
  ...
  function apex_chart_demo_6() {
    ...
    new ApexCharts(
      document.querySelector("#apex_chart_demo_6"),
      options,
    ).render();
  }
  ...
  function apex_chart_demo_7() {
    ...
    new ApexCharts(
      document.querySelector("#apex_chart_demo_7"),
      options,
    ).render();
  }
